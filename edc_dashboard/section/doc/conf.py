# -*- coding: utf-8 -*-
#
# bhp_section documentation build configuration file, created by
...
htmlhelp_basename = 'bhp_sectiondoc'
...
latex_documents = [
  ('index', 'bhp_section.tex', u'bhp\\_section Documentation',
...
man_pages = [
    ('index', 'bhp_section', u'bhp_section Documentation',
...
texinfo_documents = [
  ('index', 'bhp_section', u'bhp_section Documentation',
   u'erik van widenfelt', 'bhp_section', 'One line description of project.',
   'Miscellaneous'),
]
